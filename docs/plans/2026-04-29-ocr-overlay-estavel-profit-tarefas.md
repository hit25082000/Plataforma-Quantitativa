...
## GAP P0 Atual (2026-05-02)

- `GAP-P0-AXIS-NOT-FOUND-REAL` bloqueia execucao confiavel dos cenarios finais.
- Tese ativa: overlay nao fecha; eixo OCR degrada e mascara operacao como "morreu".
- Evidencia obrigatoria para fechamento:
  - `full_screen.png`
...
- Dependencia explicita:
  - `CEN-04` e `CEN-05` so avancam apos fechamento do `GAP-P0-AXIS-NOT-FOUND-REAL`.
