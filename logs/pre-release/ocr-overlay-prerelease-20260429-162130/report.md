...
- generated_at: `2026-04-29 16:21:30`
- overall_ok: `1`
- ok: `31`
- warn: `2`
- fail: `0`
...
| bundle:resources/ocr_overlay_audit.py | warn | ausente no bundle; validar necessidade em runtime do OCR |
| hygiene:pycache | warn | 2 arquivo(s) pyc em resources; remover do pacote |
